...
def main(args):
    ...
    if args.joined_dictionary:
        ...
        act_file = args.tgtdict.replace('trg', 'act').replace('.no_symbol', '')
        act_dict = task.load_dictionary(act_file)
        act_lang = 'act'
    ...
    act_dict.save(_dict_path(act_lang, args.destdir))
    ...
    _make_all(act_lang, act_dict, args)
